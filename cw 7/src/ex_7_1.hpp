...
void drawObjectTexture(Core::RenderContext& context, glm::mat4 modelMatrix, GLuint textureID, GLuint normalmapId, GLuint programTex){
...
void drawSpaceship(Core::RenderContext& context, glm::mat4 modelMatrix, GLuint textureID1, GLuint textureID2, GLuint textureID3, GLuint normalmapId) {
...
void renderScene(GLFWwindow* window)
{
	...
	drawObjectTexture(sphereContext, earthTransformation, texture::earth, texture::earthNormal, programTex);
	...
	drawObjectTexture(sphereContext, moonTransformation, texture::moon, texture::moonNormal, programTex);
	...
	drawSpaceship(n_shipContext, shipTransformation, texture::ship, texture::scratches, texture::rust, texture::shipNormal);
