...
glm::vec4 bg_color(0.0f, 0.3f, 0.3f, 1.0f);
...
void renderScene(GLFWwindow* window)
{
	...
	glm::mat4 transformation = glm::eulerAngleXYZ(0.5f, 0.5f, -0.2f);
	glUniformMatrix4fv(glGetUniformLocation(program, "transformation"), 1, GL_FALSE, (float*)&transformation);
	glUniform1f(glGetUniformLocation(program, "time"), time);
	glUniform4fv(glGetUniformLocation(program, "bg_color"), 1, (float*)&bg_color);
...
void init(GLFWwindow* window)
{
	...
	// 6. Aktywuj atrybut powiązany z kolorem wierchołków za pomocą glEnableVertexAttribArray(GLuint index). 
	//Indeks jest zapisany w shaderze wierzchołków w 4. lini. Można odpytać shader o indeks za pomocą funkcji glGetAttribLocation(GL uint program, const GLchar *name)
